...
{
    public partial class ActiveIngredientEdit : EMGForm
    {
        public ActiveIngredientEdit()
        {
            InitializeComponent();
        }
        OnkolabDb db = new OnkolabDb();
        public EtkenMadde obj = new EtkenMadde();
        String mesaj = "Etkan Madde";
        ...
        private void ProtokolEdit_Load_1(object sender, EventArgs e)
        {
            ...
            EMGFormEvents.LookUp(extension.ToDataTable(db.Protokols.ToList()), txtProtokolId, "Id", "Name", "Protokol");
        ...
        public void Yukle()
        {
            ...
            {
                obj = db.EtkenMadde.FirstOrDefault(a => a.Id == obj.Id);
