...
{
    public partial class InjectorEdit : EMGForm
    {
        public InjectorEdit()
        {
            InitializeComponent();
        ...
        public Injectors obj = new Injectors();
        String mesaj = "Enjektör";
        ...
        public void Yukle()
        {
            ...
            {
                obj = db.Injectors.FirstOrDefault(a => a.Id == obj.Id);
