...
namespace IVTRON
{
    public partial class MainDiagnosisList :EMGForm
    {


        public MainDiagnosisList()
        {
            InitializeComponent();
            UniqueName = "Id";
        ...
        public void Yukle()
        {
            ...
            var table = dbNew.MainDiagnosis.ToList();
        ...
        public void Duzenle()
        {
            ...
            int Value = GView.GetDataRow(index)[UniqueName].ToInt();
                ...
                MainDiagnosisEdit form = new MainDiagnosisEdit();
                form.obj.Id = Value;
        ...
        public void Yeni()
        {
           new MainDiagnosisEdit().ShowDialog();
