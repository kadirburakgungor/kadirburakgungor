...
{
    public partial class HastaKayit : EMGForm
    {
        public HastaKayit()
        {
            InitializeComponent();
        ...
        public void Yukle()
        {
            ...
            var table = dbNew.Patients.ToList();
            ...
            foreach (DevExpress.XtraGrid.Columns.GridColumn item in GView.Columns)
            {
        ...
        public void Duzenle()
        {
            ...
            PatientEdit form = new PatientEdit();
            form.obj.Id = Value;
