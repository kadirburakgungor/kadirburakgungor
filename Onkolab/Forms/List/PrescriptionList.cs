...
{
    public partial class PrescriptionList : EMGForm
    {
        ...
        public void Yukle()
        {
            ...
            var table = dbNew.Database.SqlQuery<List_Prescription_SP_Result>("List_Prescription_SP").ToList();
        ...
        public void Duzenle()
        {
            ...
            PrescriptionEdit form = new PrescriptionEdit();
            form.obj.Id = Value;
        ...
        public void Yeni()
        {
            new PrescriptionEdit().ShowDialog();
