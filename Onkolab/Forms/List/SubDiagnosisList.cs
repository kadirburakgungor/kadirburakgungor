...
{
    public partial class SubDiagnosisList : EMGForm
    {
        public SubDiagnosisList()
        {
            InitializeComponent();
            UniqueName = "Id";
        ...
        public void Yukle()
        {
            ...
            var table = dbNew.Database.SqlQuery<List_Sub_Diagnosis_Result>("List_Sub_Diagnosis").ToList();
        ...
        public void Duzenle()
        {
            ...
            SubDiagnosisEdit form = new SubDiagnosisEdit();
            form.obj.Id = Value;
        ...
        public void Yeni()
        {
            new SubDiagnosisEdit().ShowDialog();
